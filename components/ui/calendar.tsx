      ...
      <span className="select-none font-medium flex items-center gap-1.5">
        ...
        <span className="relative inline-block">
          <button
            ...
            className="cursor-pointer font-semibold hover:text-primary hover:underline underline-offset-2 transition-colors px-1 py-0.5 rounded hover:bg-accent/50"
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: cn(
          "flex items-center justify-center h-(--cell-size) w-full px-(--cell-size) font-medium text-sm select-none",
