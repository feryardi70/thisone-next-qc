...
export default function EditDataDentalIntraoralForm({ payloadQueryParams }: DentalProps) {
  ...
  const handleEdit = async (e: React.FormEvent) => {
    ...
    if (editResponse.status == 200) {
      ...
      router.push(`/dashboard/dental/kolimasi?No_Seri=${editResult.data.No_Seri}&id=${editResult.data.id_user}`);
    } else {
  ...
  return (
    <div>
      <div className="flex min-h-screen overflow-hidden bg-gradient-to-br from-cyan-50 to-blue-100">
        <SideBar />
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <main className="mt-3 flex justify-center items-center">
            <div className="px-5 py-5 shadow-md max-w-xl min-h-screen w-full border-t-4 border-cyan-500 text-black">
              <h2 className="mb-5 text-center text-3xl">Form Edit Data Dental</h2>
              ...
              <form onSubmit={(e) => handleEdit(e)} className="flex flex-col">
                <div className="flex justify-between">
                  <div className="flex flex-col w-[48%]">
                    ...
                    <input
                      type="text"
                      className="px-2 py-2 mb-5 border-2 border-cyan-200 focus:border-cyan-700 rounded-md outline-none"
                      id="Merk"
                      name="Merk"
                      value={dataUji.Merk || ""}
                    ...
                    <input
                      type="text"
                      className="px-2 py-2 mb-5 border border-cyan-200 focus:border-cyan-700 rounded-md outline-none"
                      id="Model"
                      name="Model"
                      value={dataUji.Model || ""}
                  ...
                  <div className="flex flex-col w-[48%]">
                    ...
                    <input
                      ...
                      onChange={(e) => setDataUji({ ...dataUji, jenis_pesawat: e.target.value })}
                      placeholder="Dental"
                ...
                <button type="submit" className="px-2 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 rounded text-white">
