...
import { useFetchRadMachineByUserIdnSNNumberForAkurKV } from "@/app/DAL/service/radiografi-service";
...
export default function DashboardRadAkurKV({
  payloadQueryParams,
}: DashboardRadProps) {
  const { dataUji, allDataUji, isLoading, errorMsg } =
    useFetchRadMachineByUserIdnSNNumberForAkurKV({ payloadQueryParams });
    ...
    <div className="flex flex-wrap justify-center gap-1 mb-4">
      {identifikasiPesawatUnik.map((item, index) => {
        ...
        const isActive =
          ...
          (pathname.startsWith("/dashboard/radiografi/akurasi-kvp") &&
