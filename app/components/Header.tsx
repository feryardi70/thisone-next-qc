    ...
    <header className="h-16 flex items-center justify-between px-6">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button className="flex items-center gap-2 border-2 p-1 rounded-full hover:bg-gray-100">
            <UserRound size={25} color="green" />
          </button>
        </DropdownMenuTrigger>

        <DropdownMenuContent align="start" className="w-72 flex flex-col justify-center items-center">
          ...
          <DropdownMenuItem className="mt-5">
            <div className="px-6 py-3 bg-green-500 rounded-lg flex flex-row gap-1">
              <UserCog /> 
              <div>Setting</div>
            </div>
            <div className="px-3 py-3 bg-green-500 rounded-lg flex flex-row gap-1">
              <Crown color="yellow"/>
