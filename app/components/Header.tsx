  ...
  return (
    <header className="h-16 flex items-center justify-end px-6">
      <DropdownMenu>
        ...
        <DropdownMenuContent align="start" className="w-[410px] min-h-64 flex flex-col justify-center items-center">
          ...
          <div className="flex flex-row justify-center items-center">
            ...
            <DropdownMenuItem className="mt-5" onSelect={(e) => e.preventDefault()}>
              <button onClick={() => setOpenDialog(true)} className="px-3 py-3 hover:px-4 hover:py-4 bg-green-500 hover:shadow-black hover:shadow-lg rounded-lg flex flex-row gap-1 ml-[-8px]">
      ...
      <AlertDialog open={openDialog} onOpenChange={setOpenDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>You will be logged out and redirected to the login page.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel className="border-emerald-700 hover:text-emerald-600">Cancel</AlertDialogCancel>
            <AlertDialogAction className="bg-green-600 hover:bg-fuchsia-400" onClick={handleSignOut}>
              Continue
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
