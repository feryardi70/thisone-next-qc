...
export default function AddNewDataDentalForm({ payloadQueryParams }: DentalProps) {
  ...
  return (
    <div>
      <div className="flex min-h-screen overflow-hidden bg-linear-to-br from-cyan-50 to-blue-100">
        <SideBar />
          ...
          <main className="mt-3 flex justify-center items-center">
            <div className="px-5 py-5 shadow-md max-w-xl min-h-screen w-full border-t-4 border-cyan-500 text-black">
              ...
              <form onSubmit={(e) => handleSubmit(e)} className="flex flex-col">
                ...
                <button type="submit" className="px-2 py-2 bg-linear-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 rounded text-white">
