...
import EditDataFloComponent from "@/app/components/fluoroskopi/FormEditDataFlo";
...
export default async function DaftarPesawatFluoroskopiPage({ params }: { params: Promise<{ No_Seri: string }> }) {
  ...
  return (
    <div>
      <EditDataFloComponent payloadQueryParams={payloadQueryParams} />
    </div>
  );
}
