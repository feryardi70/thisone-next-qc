...
import DataUjiPesawatFlo from "@/app/components/fluoroskopi/dataUjiPesawatFlo";
import { redirect } from "next/navigation";

export default async function DaftarPesawatRadiografiPage({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  return (
    <div>
      <DataUjiPesawatFlo payloadQueryParams={payloadQueryParams} />
    </div>
  );
}
