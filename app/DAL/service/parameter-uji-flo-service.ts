...
import { updateDataUjiFloByIdParameter } from "../repository/parameter-uji-flo-repository";
...
export const editDataUjiFloByIdParameter = async (
  Kolimasi_deltaX: string,
  Kolimasi_deltaY: string,
  Titik_pusat: string,
  Akurasi_kV: string,
  ...
  const updateResponse = await updateDataUjiFloByIdParameter(data, id_parameter);
