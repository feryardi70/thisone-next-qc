...
export const editDataRadByIdSpec = async(dataUjiData: any) => {
...
export const updateDataRadByIdSpec = async (data: any, id_spesifikasi: string) => {
...
export const addDataRad = async (dataUjiData: any) => {
...
export const saveDataRad = async (data: any) => {
