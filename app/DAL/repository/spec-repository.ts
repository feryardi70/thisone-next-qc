...
export const getDataRadByIdSpec = async (id_spesifikasi: string | number) => {
  const response = await fetch(`${baseUrl}/qc/radiografi/spesifikasi/pre-report?id_spesifikasi=${id_spesifikasi}`);
  const data = await response.json();
...
export const updateDataRadByIdSpec = async (data: DataUji2nd, id_spesifikasi: string) => {
  const updateResponse = await fetch(`${externalApiUrl}/qc-data-radiografi/spesifikasi/${id_spesifikasi}`, {
    method: "PATCH",
    headers: {
      "Content-Type": "application/json",
    },
...
export const addDataFlo = async (dataUjiData: DataUji3rd) => {
  const saveResponse = await fetch(`${baseUrl}/qc/fluoroskopi/spesifikasi`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export const saveDataFlo = async (data: DataUji3rd) => {
  const saveResponse = await fetch(`${externalApiUrl}/qc-data-fluoroskopi/spesifikasi`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
