...
import { readDataCtForHvlByUserIdnSNNumber } from "@/app/DAL/repository/ct-repository";
...
export async function GET(request: Request, segmentData: { params: Params }) {
  ...
  const qcData = await readDataCtForHvlByUserIdnSNNumber(Number(id_user), No_Seri);
